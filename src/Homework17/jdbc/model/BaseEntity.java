...
import Homework17.jdbc.exceptions.GenericDaoException;
...
public abstract class BaseEntity <PK extends Serializable> implements BaseEntityInterface<PK> {
    ...
    private static final String RESOURCES_DB_PROPERTIES = "/Java/IdeaProjects/Homework/src/Homework17/resources/db.properties";
